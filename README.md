...
Tags: email newsletter, newsletters, newsletter signup, email signup, email marketing  
...
This is a compatibility tester plugin for the Mailster Email Newsletter Plugin available at: [mailster.co](https://mailster.co/?utm_campaign=wporg&utm_source=wordpress.org&utm_medium=plugin&utm_term=Mailster+Compatibility+Tester)
...
**[Account →](https://mailster.co/account/)**
...
For further details please visit [the changelog on the Mailster Homepage](https://mailster.co/?utm_campaign=wporg&utm_source=wordpress.org&utm_medium=plugin&utm_term=Mailster+Compatibility+Tester)
